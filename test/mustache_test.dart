...
main() {
    ...
    group('Basic', () {
        test('Variable', () {
            final String output = parse('_{{var}}_').renderString({"var": "bob"});
    ...
    group('Section', () {
        ...
        test('Invalid value - lenient mode', () {
            final String output = parse('{{#var}}_{{var}}_{{/var}}', lenient: true)
                .renderString({'var': 42});
...
'''));
    ...
    group('Inverse Section', () {
        ...
        test('False', () {
            final String output = parse('{{^section}}_ok_{{/section}}')
                .renderString({"section": false});
            expect(output, equals('_ok_'));
        });
        test('Invalid value', () {
        ...
        test('Invalid value - lenient mode', () {
            final String output = parse('{{^var}}_ok_{{/var}}', lenient: true)
                .renderString({'var': 42});
            expect(output, equals(''));
        });
        test('True', () {
    ...
    group('Html escape', () {
        test('Escape at start', () {
            final String output = parse('_{{var}}_').renderString({"var": "&."});
    ...
    group('Lenient', () {
        test('Odd section name', () {
            final String output = parse(r'{{#section$%$^%}}_{{var}}_{{/section$%$^%}}',
        ...
        test('Null section', () {
            final String output = parse('{{#section}}_{{var}}_{{/section}}', lenient: true)
    ...
    group('Escape tags', () {
        test('{{{ ... }}}', () {
            final String output = parse('{{{blah}}}').renderString({'blah': '&'});
            expect(output, equals('&'));
        });
        test('{{& ... }}', () {
            final String output = parse('{{{blah}}}').renderString({'blah': '&'});
    ...
    group('Partial tag', () {
        ...
        test('basic', () {
            final String output = _partialTest({'foo': 'bar'},
        ...
        test('missing partial lenient', () {
            final String output = _partialTest(
